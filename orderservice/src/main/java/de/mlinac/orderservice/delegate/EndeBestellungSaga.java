...
@Component
public class EndeBestellungSaga implements ExecutionListener {
    ...
    public void notify(DelegateExecution execution) throws Exception {
        ...
        bestellungService.statusBestellung(bestellnummer, Status.STORNIERT);
        log.info("SAGA beendet. Bestellung: "+ bestellnummer);
    }
}
